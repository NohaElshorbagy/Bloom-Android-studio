...
public class TinyDB {
    ...
    public ArrayList<PlantDomain> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<PlantDomain> playerList =  new ArrayList<PlantDomain>();

        for(String jObjString : objStrings){
            PlantDomain player  = gson.fromJson(jObjString,  PlantDomain.class);
    ...
    public void putListObject(String key, ArrayList<PlantDomain> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(PlantDomain player: playerList){
