...
public class MostSellingAdapterr extends RecyclerView.Adapter<MostSellingAdapterr.MyViewHolder>{
    String title[] , fee[] ;
    int images[];
    Context context;
    public MostSellingAdapterr(Context ct , String s1[], String s3[], int img[])
    {
        context = ct;
        title=s1;
        fee=s3;
    ...
    @NonNull
    @Override
    public MostSellingAdapterr.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View v= inflater.inflate(R.layout.viewholder , parent , false);
        return new MostSellingAdapterr.MyViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull MostSellingAdapterr.MyViewHolder holder, int position) {
